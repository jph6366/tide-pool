                                    ...
                                    <div className="flex items-center pl-5">
                                        ...
                                        <a 
                                            ...
                                            onClick={(e) => {
                                                ...
                                                window.open(
                                                `https://www.marine-geo.org/tools/search/mapview.php?entry_id=${cruise.entry_id}`,
                                                '_blank',
